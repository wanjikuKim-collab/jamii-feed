                ...
                <div className='bg-black text-white rounded-3xl p-10'>
                  ...
                  <form className='text-left'>
                    ...
                    <div className='space-y-1'>
                      ...
                      <input className='block rounded border-0 bg-white px-3 w-full h-10 text-blue-dark' type="password" name="password" placeholder="Password" required/>
                    </div>

                    <div className='w-full text-center flex items-center'>
                      <button className='w-full bg-blue-500 rounded p-2 mt-6 text-white lg:text-xl font-bold bottom-0 hover:bg-blue-light' type="submit">Log In</button>
                    </div>
